...
But first, **please answer the remaining Open Questions above** (device target, guest OS, VM image, etc.) so we can tailor the implementation to your environment.
